...
class SLP_Power_Text extends SLPlus_BaseClass_Object {
    ...
    private function init_text() {
	    ...
	    $this->text['description']['tag_output_processing'  ] = __( 'How should tags be output in the results below the map and the info bubble?', 'slp-power' );
	    ...
	    $this->text['general'    ]['geocode_after_import'   ] = __( 'Locations will be geocoded after they are imported.'  , 'slp-power' );
	    ...
	    $this->text['label']['tag_output_processing'        ] = __('Category Selector', 'slp-power');

	    $this->text['option_default']['label_category'      ] = __('Show Tags In Output','slp-power');
